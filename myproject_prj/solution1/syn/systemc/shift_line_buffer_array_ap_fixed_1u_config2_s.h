...
struct shift_line_buffer_array_ap_fixed_1u_config2_s : public sc_module {
    ...
    sc_in< sc_lv<32> > in_elem_data_V_read;
    sc_in< sc_lv<32> > kernel_window_1_V_read;
    sc_in< sc_lv<32> > kernel_window_2_V_read;
    ...
    shift_line_buffer_array_ap_fixed_1u_config2_s_line_bufferbkb* line_buffer_Array_V_1465_0_U;
    sc_signal< sc_lv<1> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > line_buffer_Array_V_0_0_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_0_0_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_0_0_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1465_0_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1465_0_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1465_0_q0;
    ...
    void thread_line_buffer_Array_V_1465_0_ce0();
    void thread_line_buffer_Array_V_1465_0_we0();
