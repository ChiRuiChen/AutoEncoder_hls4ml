...
#ifndef _shift_line_buffer_array_ap_fixed_4u_config11_s_HH_
#define _shift_line_buffer_array_ap_fixed_4u_config11_s_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6.h"

namespace ap_rtl {

struct shift_line_buffer_array_ap_fixed_4u_config11_s : public sc_module {
    ...
    // Module declarations
    shift_line_buffer_array_ap_fixed_4u_config11_s(sc_module_name name);
    SC_HAS_PROCESS(shift_line_buffer_array_ap_fixed_4u_config11_s);

    ~shift_line_buffer_array_ap_fixed_4u_config11_s();

    sc_trace_file* mVcdFile;

    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_0_0_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_1_0_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_0_1_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_1_1_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_0_2_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_1_2_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_0_3_U;
    shift_line_buffer_array_ap_fixed_4u_config11_s_line_buffeRg6* line_buffer_Array_V_1_1_3_U;
    sc_signal< sc_lv<1> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_0_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_0_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_0_0_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_0_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_0_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_1_0_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_1_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_1_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_0_1_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_1_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_1_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_1_1_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_2_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_2_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_0_2_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_2_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_2_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_1_2_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_3_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_0_3_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_0_3_q0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_3_ce0;
    sc_signal< sc_logic > line_buffer_Array_V_1_1_3_we0;
    sc_signal< sc_lv<32> > line_buffer_Array_V_1_1_3_q0;
