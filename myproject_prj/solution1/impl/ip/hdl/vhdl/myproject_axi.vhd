...
architecture behav of myproject_axi is 
    ...
    "myproject_axi,hls_ip_2019_2_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.429000,HLS_SYN_LAT=96019,HLS_SYN_TPT=50865,HLS_SYN_MEM=289,HLS_SYN_DSP=118,HLS_SYN_FF=53257,HLS_SYN_LUT=35689,HLS_VERSION=2019_2_1}";
    ...
    signal Loop_1_proc574_U0_ap_start : STD_LOGIC;
    signal Loop_1_proc574_U0_start_full_n : STD_LOGIC;
    signal Loop_1_proc574_U0_ap_done : STD_LOGIC;
    signal Loop_1_proc574_U0_ap_continue : STD_LOGIC;
    signal Loop_1_proc574_U0_ap_idle : STD_LOGIC;
    signal Loop_1_proc574_U0_ap_ready : STD_LOGIC;
    signal Loop_1_proc574_U0_start_out : STD_LOGIC;
    signal Loop_1_proc574_U0_start_write : STD_LOGIC;
    signal Loop_1_proc574_U0_in_r_TREADY : STD_LOGIC;
    signal Loop_1_proc574_U0_in_local_V_data_0_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_1_proc574_U0_in_local_V_data_0_V_write : STD_LOGIC;
    signal Loop_1_proc574_U0_is_last_0_i_out_out_din : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_1_proc574_U0_is_last_0_i_out_out_write : STD_LOGIC;
    signal myproject_U0_conv2d_147_input_V_data_V_read : STD_LOGIC;
    signal myproject_U0_layer21_out_V_data_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal myproject_U0_layer21_out_V_data_V_write : STD_LOGIC;
    ...
    signal in_local_V_data_0_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component fifo_w32_d1024_A_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    Loop_1_proc574_U0 : component Loop_1_proc574
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Loop_1_proc574_U0_ap_start,
        start_full_n => Loop_1_proc574_U0_start_full_n,
        ap_done => Loop_1_proc574_U0_ap_done,
        ap_continue => Loop_1_proc574_U0_ap_continue,
        ap_idle => Loop_1_proc574_U0_ap_idle,
        ap_ready => Loop_1_proc574_U0_ap_ready,
        start_out => Loop_1_proc574_U0_start_out,
        start_write => Loop_1_proc574_U0_start_write,
        in_r_TLAST => in_r_TLAST,
        in_r_TVALID => in_r_TVALID,
        in_r_TREADY => Loop_1_proc574_U0_in_r_TREADY,
        in_local_V_data_0_V_din => Loop_1_proc574_U0_in_local_V_data_0_V_din,
        in_local_V_data_0_V_full_n => in_local_V_data_0_V_full_n,
        in_local_V_data_0_V_write => Loop_1_proc574_U0_in_local_V_data_0_V_write,
        in_r_TDATA => in_r_TDATA,
        is_last_0_i_out_out_din => Loop_1_proc574_U0_is_last_0_i_out_out_din,
        is_last_0_i_out_out_full_n => is_last_0_i_loc_c_full_n,
        is_last_0_i_out_out_write => Loop_1_proc574_U0_is_last_0_i_out_out_write);

    myproject_U0 : component myproject
    port map (
        conv2d_147_input_V_data_V_dout => in_local_V_data_0_V_dout,
        conv2d_147_input_V_data_V_empty_n => in_local_V_data_0_V_empty_n,
        conv2d_147_input_V_data_V_read => myproject_U0_conv2d_147_input_V_data_V_read,
        layer21_out_V_data_V_din => myproject_U0_layer21_out_V_data_V_din,
        layer21_out_V_data_V_full_n => out_local_V_data_0_V_full_n,
        layer21_out_V_data_V_write => myproject_U0_layer21_out_V_data_V_write,
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    in_local_V_data_0_V_U : component fifo_w32_d1024_A_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Loop_1_proc574_U0_in_local_V_data_0_V_din,
        if_full_n => in_local_V_data_0_V_full_n,
        if_write => Loop_1_proc574_U0_in_local_V_data_0_V_write,
        if_dout => in_local_V_data_0_V_dout,
        if_empty_n => in_local_V_data_0_V_empty_n,
        if_read => myproject_U0_conv2d_147_input_V_data_V_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Loop_1_proc574_U0_is_last_0_i_out_out_din,
        if_full_n => is_last_0_i_loc_c_full_n,
        if_write => Loop_1_proc574_U0_is_last_0_i_out_out_write,
        if_dout => is_last_0_i_loc_c_dout,
        if_empty_n => is_last_0_i_loc_c_empty_n,
        if_read => Loop_2_proc_U0_is_last_0_i_loc_read);

    out_local_V_data_0_V_U : component fifo_w32_d1024_A_x
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => myproject_U0_layer21_out_V_data_V_din,
        if_full_n => out_local_V_data_0_V_full_n,
        if_write => myproject_U0_layer21_out_V_data_V_write,
    ...
    port map (
        ...
        if_write => Loop_1_proc574_U0_start_write,
    ...
    Loop_1_proc574_U0_start_full_n <= (start_for_myproject_U0_full_n and start_for_Loop_2_proc_U0_full_n);
