...
module zeropad2d_cl_array_array_ap_fixed_4u_config25_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
assign i_fu_162_p2 = (i1_0_reg_111 + 3'd1);

assign icmp_ln56_fu_144_p2 = ((j_0_reg_100 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln61_fu_156_p2 = ((i1_0_reg_111 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln65_fu_168_p2 = ((j3_0_reg_122 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln74_fu_200_p2 = ((j6_0_reg_133 == 3'd6) ? 1'b1 : 1'b0);
...
assign j_10_fu_174_p2 = (j3_0_reg_122 + 3'd1);

assign j_9_fu_206_p2 = (j6_0_reg_133 + 3'd1);

assign j_fu_150_p2 = (j_0_reg_100 + 3'd1);

assign start_out = real_start;

endmodule //zeropad2d_cl_array_array_ap_fixed_4u_config25_s
