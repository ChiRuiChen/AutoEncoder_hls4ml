...
wire   [0:0] icmp_ln35_fu_129_p2;
reg    is_last_0_i_loc_blk_n;
reg   [0:0] is_last_0_i_loc_read_reg_418;
reg    ap_block_state1;
wire   [10:0] i_fu_135_p2;
reg   [10:0] i_reg_426;
wire    regslice_both_out_data_U_apdone_blk;
reg    ap_block_state2;
reg   [31:0] tmp_data_0_V_reg_431;
...
wire   [31:0] tmp_V_3_fu_170_p3;
reg   [31:0] tmp_V_3_reg_459;
...
wire   [8:0] tmp_189_i_i_fu_383_p3;
...
myproject_axi_lshr_32ns_32ns_32_2_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
myproject_axi_lshr_32ns_32ns_32_2_1_U769(
    .clk(ap_clk),
    .reset(ap_rst),
...
myproject_axi_shl_64ns_32ns_64_2_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
myproject_axi_shl_64ns_32ns_64_2_1_U770(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_321_p0),
    .din1(grp_fu_321_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0))) & (icmp_ln35_fu_129_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0))) & (icmp_ln35_fu_129_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        last_reg_438 <= last_fu_147_p2;
        p_Result_3_reg_443 <= out_local_V_data_0_V_dout[32'd31];
...
always @ (posedge ap_clk) begin
    if (((icmp_ln935_reg_454 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        tmp_11_reg_551 <= m_2_fu_339_p2[32'd25];
    end
end
...
always @ (*) begin
    if ((~((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0))) & (icmp_ln35_fu_129_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln35_fu_129_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0))) & (icmp_ln35_fu_129_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0))) & (icmp_ln35_fu_129_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state2 = ((regslice_both_out_data_U_apdone_blk == 1'b1) | ((icmp_ln35_fu_129_p2 == 1'd0) & (out_local_V_data_0_V_empty_n == 1'b0)));
end

assign bitcast_ln739_fu_406_p1 = trunc_ln738_fu_402_p1;

assign grp_fu_321_p0 = tmp_V_3_reg_459;

assign grp_fu_321_p1 = sub_ln958_reg_511;

assign i_fu_135_p2 = (i1_0_i_i_reg_118 + 11'd1);

assign icmp_ln35_fu_129_p2 = ((i1_0_i_i_reg_118 == 11'd1024) ? 1'b1 : 1'b0);

assign icmp_ln38_fu_141_p2 = ((i1_0_i_i_reg_118 == 11'd1023) ? 1'b1 : 1'b0);

assign icmp_ln935_fu_165_p2 = ((tmp_data_0_V_reg_431 == 32'd0) ? 1'b1 : 1'b0);
...
assign last_fu_147_p2 = (is_last_0_i_loc_read_reg_418 & icmp_ln38_fu_141_p2);
...
assign p_Result_1_fu_280_p3 = tmp_V_3_reg_459[lsb_index_reg_489];

integer ap_tvar_int_0;

always @ (tmp_V_3_fu_170_p3) begin
    for (ap_tvar_int_0 = 32 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 31 - 0) begin
            p_Result_4_fu_175_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            p_Result_4_fu_175_p4[ap_tvar_int_0] = tmp_V_3_fu_170_p3[31 - ap_tvar_int_0];
        end
    end
end

assign p_Result_5_fu_390_p5 = {{m_6_fu_370_p1[63:32]}, {tmp_189_i_i_fu_383_p3}, {m_6_fu_370_p1[22:0]}};

assign p_Result_s_fu_250_p2 = (tmp_V_3_reg_459 & lshr_ln947_fu_244_p2);

assign select_ln964_fu_363_p3 = ((tmp_11_reg_551[0:0] === 1'b1) ? 8'd127 : 8'd126);
...
assign tmp_10_fu_267_p3 = lsb_index_reg_489[32'd31];

assign tmp_189_i_i_fu_383_p3 = {{p_Result_3_reg_443}, {add_ln964_fu_378_p2}};

assign tmp_V_3_fu_170_p3 = ((p_Result_3_reg_443[0:0] === 1'b1) ? tmp_V_reg_449 : tmp_data_0_V_reg_431);

assign tmp_V_fu_160_p2 = (32'd0 - tmp_data_0_V_reg_431);
...
assign xor_ln949_fu_274_p2 = (tmp_10_fu_267_p3 ^ 1'd1);
