...
output   ap_idle;
output   ap_ready;
input  [31:0] in_elem_data_V_read;
input  [31:0] kernel_window_1_V_read;
input  [31:0] kernel_window_2_V_read;
...
wire   [31:0] line_buffer_Array_V_0_0_q0;
reg    line_buffer_Array_V_1465_0_ce0;
reg    line_buffer_Array_V_1465_0_we0;
wire   [31:0] line_buffer_Array_V_1465_0_q0;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        line_buffer_Array_V_1465_0_ce0 = 1'd1;
    end else begin
        line_buffer_Array_V_1465_0_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        line_buffer_Array_V_1465_0_we0 = 1'd1;
    end else begin
        line_buffer_Array_V_1465_0_we0 = 1'b0;
    end
end
...
assign ap_return_4 = line_buffer_Array_V_1465_0_q0;

assign ap_return_5 = kernel_window_5_V_read;

assign ap_return_6 = line_buffer_Array_V_0_0_q0;
