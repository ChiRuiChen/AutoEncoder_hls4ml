...
input   in_r_TVALID;
output   in_r_TREADY;
output  [31:0] in_local_V_data_0_V_din;
...
wire   [0:0] or_ln28_fu_157_p2;
reg   [0:0] or_ln28_reg_443;
wire   [62:0] trunc_ln557_fu_167_p1;
reg   [62:0] trunc_ln557_reg_448;
wire    ap_CS_fsm_state4;
reg   [0:0] tmp_reg_453;
reg   [10:0] p_Result_i_i_reg_458;
wire   [51:0] trunc_ln565_fu_189_p1;
reg   [51:0] trunc_ln565_reg_463;
wire   [53:0] select_ln570_fu_213_p3;
reg   [53:0] select_ln570_reg_468;
wire    ap_CS_fsm_state5;
wire   [0:0] icmp_ln571_fu_220_p2;
reg   [0:0] icmp_ln571_reg_473;
wire   [0:0] icmp_ln581_fu_231_p2;
reg   [0:0] icmp_ln581_reg_479;
wire  signed [11:0] select_ln581_fu_249_p3;
reg  signed [11:0] select_ln581_reg_485;
wire   [0:0] icmp_ln582_fu_257_p2;
reg   [0:0] icmp_ln582_reg_491;
wire   [31:0] trunc_ln583_fu_263_p1;
reg   [31:0] trunc_ln583_reg_497;
reg   [6:0] tmp_12_reg_503;
...
reg   [0:0] is_last_0_i_out_dc_0_reg_110;
reg    ap_block_state1;
reg   [10:0] i_0_i_i_reg_122;
wire   [63:0] grp_fu_133_p1;
wire   [63:0] bitcast_ln696_fu_163_p1;
wire   [52:0] tmp_i_fu_196_p3;
wire   [53:0] zext_ln569_fu_203_p1;
wire   [53:0] sub_ln461_fu_207_p2;
wire   [11:0] zext_ln461_fu_193_p1;
wire   [11:0] sub_ln575_fu_225_p2;
wire   [11:0] add_ln581_fu_237_p2;
wire   [11:0] sub_ln581_fu_243_p2;
wire   [53:0] grp_fu_294_p1;
wire   [31:0] bitcast_ln696_1_fu_299_p1;
wire   [0:0] tmp_13_fu_302_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln23_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((in_local_V_data_0_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
        i_0_i_i_reg_122 <= i_reg_432;
    end else if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_0_i_i_reg_122 <= 11'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((in_local_V_data_0_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
        ...
        is_last_0_i_out_dc_0_reg_110 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        tmp_12_reg_503 <= {{select_ln581_fu_249_p3[11:5]}};
        trunc_ln583_reg_497 <= trunc_ln583_fu_263_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln23_fu_136_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        p_Result_i_i_reg_458 <= {{bitcast_ln696_fu_163_p1[62:52]}};
        tmp_reg_453 <= bitcast_ln696_fu_163_p1[32'd63];
...
always @ (*) begin
    if ((~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln23_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (1'b1 == ap_CS_fsm_state2)))) begin
        grp_fu_133_ce = 1'b1;
    end else begin
        grp_fu_133_ce = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln23_fu_136_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln23_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln23_fu_136_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0))) & (icmp_ln23_fu_136_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln581_fu_237_p2 = ($signed(12'd4080) + $signed(sub_ln575_fu_225_p2));
...
always @ (*) begin
    ap_block_state2 = (((icmp_ln23_fu_136_p2 == 1'd1) & (is_last_0_i_out_out_full_n == 1'b0)) | ((icmp_ln23_fu_136_p2 == 1'd0) & (in_r_TVALID_int == 1'b0)));
end

assign ap_ready = internal_ap_ready;

assign bitcast_ln696_1_fu_299_p1 = in_data_tmp_reg_437;

assign bitcast_ln696_fu_163_p1 = grp_fu_133_p1;

assign grp_fu_294_p1 = $unsigned(sext_ln581_fu_277_p1);

assign i_fu_142_p2 = (i_0_i_i_reg_122 + 11'd1);

assign icmp_ln23_fu_136_p2 = ((i_0_i_i_reg_122 == 11'd1024) ? 1'b1 : 1'b0);

assign icmp_ln571_fu_220_p2 = ((trunc_ln557_reg_448 == 63'd0) ? 1'b1 : 1'b0);

assign icmp_ln581_fu_231_p2 = (($signed(sub_ln575_fu_225_p2) > $signed(12'd16)) ? 1'b1 : 1'b0);

assign icmp_ln582_fu_257_p2 = ((sub_ln575_fu_225_p2 == 12'd16) ? 1'b1 : 1'b0);

assign icmp_ln585_fu_280_p2 = ((select_ln581_reg_485 < 12'd54) ? 1'b1 : 1'b0);

assign icmp_ln603_fu_285_p2 = ((tmp_12_reg_503 == 7'd0) ? 1'b1 : 1'b0);

assign in_local_V_data_0_V_din = ((or_ln603_2_reg_549[0:0] === 1'b1) ? select_ln603_2_fu_415_p3 : 32'd0);

assign is_last_0_i_out_out_din = is_last_0_i_out_dc_0_reg_110;

assign or_ln28_fu_157_p2 = (is_last_0_i_out_dc_0_reg_110 | in_r_TLAST_int);
...
assign select_ln570_fu_213_p3 = ((tmp_reg_453[0:0] === 1'b1) ? sub_ln461_fu_207_p2 : zext_ln569_fu_203_p1);

assign select_ln581_fu_249_p3 = ((icmp_ln581_fu_231_p2[0:0] === 1'b1) ? add_ln581_fu_237_p2 : sub_ln581_fu_243_p2);

assign select_ln588_fu_310_p3 = ((tmp_13_fu_302_p3[0:0] === 1'b1) ? 32'd4294967295 : 32'd0);
...
assign sext_ln581_fu_277_p1 = select_ln581_reg_485;

assign start_out = real_start;

assign sub_ln461_fu_207_p2 = (54'd0 - zext_ln569_fu_203_p1);

assign sub_ln575_fu_225_p2 = (12'd1075 - zext_ln461_fu_193_p1);

assign sub_ln581_fu_243_p2 = (12'd16 - sub_ln575_fu_225_p2);

assign tmp_13_fu_302_p3 = bitcast_ln696_1_fu_299_p1[32'd31];

assign tmp_i_fu_196_p3 = {{1'd1}, {trunc_ln565_reg_463}};

assign trunc_ln557_fu_167_p1 = bitcast_ln696_fu_163_p1[62:0];

assign trunc_ln565_fu_189_p1 = bitcast_ln696_fu_163_p1[51:0];

assign trunc_ln583_fu_263_p1 = select_ln570_fu_213_p3[31:0];
...
assign zext_ln461_fu_193_p1 = p_Result_i_i_reg_458;

assign zext_ln569_fu_203_p1 = tmp_i_fu_196_p3;

endmodule //Loop_1_proc574
