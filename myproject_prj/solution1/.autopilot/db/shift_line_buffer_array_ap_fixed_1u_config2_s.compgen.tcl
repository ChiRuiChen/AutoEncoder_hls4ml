...
set ID 14
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_fixed_1u_config2_s_line_bufferbkb
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_elem_data_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_1_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_2_V_read { I 32 vector } } \
} "
}
