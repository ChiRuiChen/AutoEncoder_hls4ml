...
set ID 229
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_fixed_4u_config8_s_line_bufferFfa
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_4_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_5_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_6_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_7_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_28_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_29_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_30_V_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_31_V_read { I 32 vector } } \
} "
}
