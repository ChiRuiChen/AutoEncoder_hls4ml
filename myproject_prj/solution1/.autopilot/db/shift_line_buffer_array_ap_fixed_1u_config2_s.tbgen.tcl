set moduleName shift_line_buffer_array_ap_fixed_1u_config2_s
set isTopModule 0
...
set C_modelName {shift_line_buffer<array<ap_fixed,1u>,config2>}
set C_modelType { int 288 }
set C_modelArgList {
	{ in_elem_data_V_read int 32 regular  }
	{ kernel_window_1_V_read int 32 regular  }
	{ kernel_window_2_V_read int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_elem_data_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "kernel_window_1_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "kernel_window_2_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_elem_data_V_read sc_in sc_lv 32 signal 0 } 
	{ kernel_window_1_V_read sc_in sc_lv 32 signal 1 } 
	{ kernel_window_2_V_read sc_in sc_lv 32 signal 2 } 
	{ kernel_window_4_V_read sc_in sc_lv 32 signal 3 } 
	{ kernel_window_5_V_read sc_in sc_lv 32 signal 4 } 
	{ kernel_window_7_V_read sc_in sc_lv 32 signal 5 } 
	{ kernel_window_8_V_read sc_in sc_lv 32 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_elem_data_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in_elem_data_V_read", "role": "default" }} , 
 	{ "name": "kernel_window_1_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "kernel_window_1_V_read", "role": "default" }} , 
 	{ "name": "kernel_window_2_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "kernel_window_2_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.line_buffer_Array_V_1465_0_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	in_elem_data_V_read { ap_none {  { in_elem_data_V_read in_data 0 32 } } }
	kernel_window_1_V_read { ap_none {  { kernel_window_1_V_read in_data 0 32 } } }
	kernel_window_2_V_read { ap_none {  { kernel_window_2_V_read in_data 0 32 } } }
